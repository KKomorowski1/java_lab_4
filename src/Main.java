...
public class Main {
    public static void main(String[] args) {
        ...
        /* zad.1
        a) napisać interfejs Inteface.CzlowiekI
        b) zadeklarować 2 metody
        c) napisać interfejs StudentI który dziedziczy po interfejsie Inteface.CzlowiekI
        d) zadeklarować 3 metody
        e) napisać interfejs PracownikI który dziedziczy po interfejsie Inteface.CzlowiekI
        ...
        */
        Student student1 = new Student("Informatyka", false);
        Student student2 = new Student("Filozofia", true);

        System.out.println(student1);
        System.out.println(student2);

        Pracownik pracownik1 = new Pracownik(true, false);
        Pracownik pracownik2 = new Pracownik(false, true);
